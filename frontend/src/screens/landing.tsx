...
import { motion } from "motion/react"; // or "motion/react" if using v12+ alpha
import type {Variants }from "motion/react"; // or "motion/react" if using v12+ alpha
...
const Landing = () => {
  ...
  // 2. Item Variants (Fade + Blur + Slide Up)
        ...
        <div className="flex flex-col items-center lg:items-start text-center lg:text-left space-y-8 z-10">
          ...
          <motion.div variants={itemVariants} className="space-y-4">
            ...
            <p className="text-zinc-500 text-lg lg:text-xl font-light max-w-md mx-auto lg:mx-0">
              Play effortlessly. A minimal interface designed for focus, strategy, and pure chess.
            </p>
          </motion.div>
          ...
          >
            <motion.span variants={buttonHoverVariants} className="absolute inset-0 -z-10 rounded-full" />

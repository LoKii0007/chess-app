    ...
    <div className='gamePage bg-[#232528e8] h-[100vh] flex flex-col justify-evenly '>
      ...
      <div className="gamePage-bottom flex justify-center items-center">
        <div className="chessboard p-5">
          <Chessboard moves={moves} playerColor={playerColor as Color} setMoves={setMoves} chess={chess} board={board} setBoard={setBoard} socket={socket} />
        </div>
        ...
        <div className="game-details p-12 flex flex-col justify-evenly items-center">
          {!started && <button onClick={() => {
            ...
            handlePlayOnline()
          }} className='p-5 bg-zinc-800 text-white px-12 rounded-full hover:bg-zinc-900 cursor-pointer'>Start Game</button>}

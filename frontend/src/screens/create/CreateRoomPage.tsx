          ...
          {!isRoomCreated ? (
            ...
            >
              ...
              <p className="text-zinc-400 mb-8">
                Create a secure room and share the ID with a friend to play a
                private match.
              </p>
            ...
            >
              ...
              <div className="flex flex-col items-center mb-8">
                ...
                <p className="text-zinc-500 text-sm mt-1">
                  {canStartGame
                    ...
                    : "Share the ID below to invite a friend."}
                </p>
              </div>
              ...
              <div className="bg-zinc-950 border border-zinc-800 rounded-xl p-4 mb-8 flex items-center justify-between group">
                <div className="flex flex-col">
                  <span className="text-xs text-zinc-500 font-mono uppercase tracking-wider mb-1">
                    Room ID
                  </span>
                  <span className="text-xl font-mono tracking-widest text-zinc-200 select-all">
                    {roomId}
                  </span>
                </div>
                <motion.button

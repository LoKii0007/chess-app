...
const JoinRoomPage = () => {
  ...
  useEffect(() => {
    ...
    const handleSocketMessage = (event: MessageEvent) => {
      ...
      if (message.type === "ERROR" || message.type === "ROOM_NOT_FOUND" || message.type === "ROOM_FULL") {
          ...
          {!roomJoined ? (
            ...
            >
              <div className="flex flex-col items-center text-center mb-8">
                ...
                <h1 className="text-2xl font-bold tracking-tight mb-2">Join Private Room</h1>
            ...
            >
              ...
              <div className="bg-zinc-950/50 rounded-lg p-4 border border-zinc-800/50">
                 <p className="text-xs text-zinc-500 uppercase tracking-widest mb-1">Room ID</p>
                 <p className="font-mono text-zinc-300 text-sm break-all">{roomId}</p>
              </div>
            </motion.div>
          )}
        </AnimatePresence>
